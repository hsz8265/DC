...
public class ObPlayerEntityModel extends BipedEntityModel<PlayerEntityRenderState> {
    /**
    ...
    public ObPlayerEntityModel(ModelPart modelPart, boolean thinArms) {
    ...
    public static ModelData getTexturedModelData(Dilation dilation, boolean slim) {
        ...
        if (slim) {
            ModelPartData modelPartData2 = modelPartData.addChild(
                    ...
                    ModelPartBuilder.create().uv(32, 48).cuboid(-2.0F, -2.0F, -4.0F, 6.0F, 12.0F, 8.0F, dilation),
                    ModelTransform.origin(10.0F, 2.0F, 0.0F)
            );
            ModelPartData modelPartData3 = modelPartData.addChild(
                    EntityModelPartNames.RIGHT_ARM,
                    ModelPartBuilder.create().uv(40, 16).cuboid(-4.0F, -2.0F, -4.0F, 6.0F, 12.0F, 8.0F, dilation),
                    ModelTransform.origin(-10.0F, 2.0F, 0.0F)
            );
            modelPartData2.addChild(
                    "left_sleeve", ModelPartBuilder.create().uv(48, 48).cuboid(-2.0F, -2.0F, -4.0F, 6.0F, 12.0F, 8.0F, dilation.add(0.25F)), ModelTransform.NONE
            );
            modelPartData3.addChild(
                    "right_sleeve", ModelPartBuilder.create().uv(40, 32).cuboid(-4.0F, -2.0F, -4.0F, 6.0F, 12.0F, 8.0F, dilation.add(0.25F)), ModelTransform.NONE
            );
        } else {
            ModelPartData modelPartData2 = modelPartData.addChild(
                    EntityModelPartNames.LEFT_ARM,
                    ModelPartBuilder.create().uv(32, 48).cuboid(-2.0F, -2.0F, -4.0F, 8.0F, 12.0F, 8.0F, dilation),
                    ModelTransform.origin(10.0F, 2.0F, 0.0F)
            );
            ModelPartData modelPartData3 = modelPartData.getChild(EntityModelPartNames.RIGHT_ARM);
            modelPartData2.addChild(
                    "left_sleeve", ModelPartBuilder.create().uv(48, 48).cuboid(-2.0F, -2.0F, -4.0F, 8.0F, 12.0F, 8.0F, dilation.add(0.25F)), ModelTransform.NONE
            );
            modelPartData3.addChild(
                    "right_sleeve", ModelPartBuilder.create().uv(40, 32).cuboid(-6.0F, -2.0F, -4.0F, 8.0F, 12.0F, 8.0F, dilation.add(0.25F)), ModelTransform.NONE
            );
        }

        ModelPartData modelPartData2 = modelPartData.addChild(
                EntityModelPartNames.LEFT_LEG,
                ModelPartBuilder.create().uv(16, 48).cuboid(-4.0F, 0.0F, -4.0F, 8.0F, 12.0F, 8.0F, dilation),
                ModelTransform.origin(3.8F, 12.0F, 0.0F)
        );
        ModelPartData modelPartData3 = modelPartData.getChild(EntityModelPartNames.RIGHT_LEG);
        modelPartData2.addChild(
                "left_pants", ModelPartBuilder.create().uv(0, 48).cuboid(-4.0F, 0.0F, -4.0F, 8.0F, 12.0F, 8.0F, dilation.add(0.25F)), ModelTransform.NONE
        );
        modelPartData3.addChild(
                "right_pants", ModelPartBuilder.create().uv(0, 32).cuboid(-4.0F, 0.0F, -4.0F, 8.0F, 12.0F, 8.0F, dilation.add(0.25F)), ModelTransform.NONE
        );
        ModelPartData modelPartData4 = modelPartData.getChild(EntityModelPartNames.BODY);
        modelPartData4.addChild(
                EntityModelPartNames.JACKET, ModelPartBuilder.create().uv(16, 32).cuboid(-8.0F, 0.0F, -4.0F, 16.0F, 12.0F, 8.0F, dilation.add(0.25F)), ModelTransform.NONE
        );
        return modelData;
    }
